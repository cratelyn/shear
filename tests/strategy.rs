...
pub fn value_strategy_non_empty() -> impl Strategy<Value = String> {
    const REASON: &'static str = "value should be non-empty";
...
pub fn values_that_fit() -> impl Strategy<Value = TestInput> {
    const REASON: &'static str = "test input should be shorter than its target length";
...
pub fn values_that_need_truncation() -> impl Strategy<Value = TestInput> {
    const REASON: &'static str = "test input should be longer than its target length";
